      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        <div className='space-y-6'>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-black rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 text-center">

            <h3 className="text-white mb-4 sm:mb-6 text-sm sm:text-base">
              Overall Performance
            </h3>
          ...
          <motion.div
            ...
            <h3 className="text-base sm:text-lg font-semibold text-black mb-6">
              Skill Evaluation
            </h3>
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='bg-black rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
